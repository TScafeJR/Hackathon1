...
import { Dimensions, StyleSheet, Text, View, TouchableOpacity, TextInput, Alert, AsyncStorage, TouchableWithoutFeedback, Keyboard } from 'react-native';
    ...
    render() {
      return (
        <View style={styles.container1}>
          ...
          />
          <TouchableOpacity style={styles.buttonRegister1} onPress={ () => {this.register2press(this.state.username, this.state.password, this.state.passwordRepeat, this.state.firstName, this.state.lastName)} }>
